...
Gem::Specification.new do |spec|
  ...
  spec.description   = '[DEPRECATED] Official AWS Ruby gem for Amazon Elastic  Inference (Amazon Elastic Inference). This gem is part of the AWS SDK for Ruby.'
  ...
  spec.post_install_message = '*** aws-sdk-elasticinference is deprecated ***'
end
